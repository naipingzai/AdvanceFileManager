...
import naipingzai.materialfile.app.BackgroundActivityStarter
import naipingzai.materialfile.app.mainExecutor
import naipingzai.materialfile.compat.mainExecutorCompat
import naipingzai.materialfile.file.FileItem
import naipingzai.materialfile.file.MimeType
import naipingzai.materialfile.file.asFileSize
import naipingzai.materialfile.file.fileProviderUri
import naipingzai.materialfile.file.loadFileItem
import naipingzai.materialfile.filelist.OpenFileAsDialogActivity
import naipingzai.materialfile.filelist.OpenFileAsDialogFragment
import naipingzai.materialfile.provider.archive.archiveFile
import naipingzai.materialfile.provider.archive.archiver.ArchiveWriter
...
import naipingzai.materialfile.provider.common.ByteStringBuilder
import naipingzai.materialfile.provider.common.InvalidFileNameException
...
import naipingzai.materialfile.provider.common.ProgressCopyOption
import naipingzai.materialfile.provider.common.ReadOnlyFileSystemException
import naipingzai.materialfile.provider.common.UserActionRequiredException
import naipingzai.materialfile.provider.common.asByteStringListPath
import naipingzai.materialfile.provider.common.copyTo
import naipingzai.materialfile.provider.common.createDirectories
import naipingzai.materialfile.provider.common.createDirectory
import naipingzai.materialfile.provider.common.createFile
import naipingzai.materialfile.provider.common.delete
import naipingzai.materialfile.provider.common.deleteIfExists
import naipingzai.materialfile.provider.common.exists
import naipingzai.materialfile.provider.common.getFileStore
import naipingzai.materialfile.provider.common.getMode
import naipingzai.materialfile.provider.common.getPath
import naipingzai.materialfile.provider.common.isDirectory
...
import naipingzai.materialfile.provider.common.newOutputStream
import naipingzai.materialfile.provider.common.readAttributes
import naipingzai.materialfile.provider.common.resolveForeign
import naipingzai.materialfile.provider.common.restoreSeLinuxContext
import naipingzai.materialfile.provider.common.setGroup
import naipingzai.materialfile.provider.common.setMode
import naipingzai.materialfile.provider.common.setOwner
import naipingzai.materialfile.provider.common.setSeLinuxContext
import naipingzai.materialfile.provider.common.toByteString
import naipingzai.materialfile.provider.common.toModeString
...
class DeleteFileJob(private val paths: List<Path>) : FileJob() {
    @Throws(IOException::class)
    override fun run() {
        // Try to move to trash first for local paths
        val remainingPaths = mutableListOf<Path>()
        for (path in paths) {
            if (path.isLinuxPath) {
        ...
        val scanInfo = scan(remainingPaths, R.plurals.file_job_delete_scan_notification_title_format)
...
class BatchRenameFileJob(private val paths: List<Path>, private val baseName: String) : FileJob() {
    @Throws(IOException::class)
    override fun run() {
