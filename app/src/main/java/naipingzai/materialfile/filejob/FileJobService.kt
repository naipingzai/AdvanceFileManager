...
import naipingzai.materialfile.util.ForegroundNotificationManager
import naipingzai.materialfile.util.removeFirst
import java.util.concurrent.Executors
import java.util.concurrent.Future
import naipingzai.materialfile.compat.removeFirstCompat
...
class FileJobService : Service() {
    ...
    companion object {
        ...
        fun batchRename(paths: List<Path>, baseName: String, context: Context) {
            startJob(BatchRenameFileJob(paths, baseName), context)
        }
