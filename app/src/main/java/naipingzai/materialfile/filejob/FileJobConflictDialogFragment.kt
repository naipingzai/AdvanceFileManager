...
import naipingzai.materialfile.compat.requireViewByIdCompat
import naipingzai.materialfile.databinding.FileJobConflictDialogViewBinding
...
import naipingzai.materialfile.file.lastModifiedInstant
import naipingzai.materialfile.filelist.appDirectoryPackageName
import naipingzai.materialfile.filelist.supportsThumbnail
...
import naipingzai.materialfile.util.shortAnimTime
import naipingzai.materialfile.util.showSoftInput
...
class FileJobConflictDialogFragment : AppCompatDialogFragment() {
    ...
    /** @see naipingzai.materialfile.filelist.FileListAdapter.onBindViewHolder */
