...
import naipingzai.materialfile.lib.foregroundcompat.ForegroundCompatView;
import naipingzai.materialfile.lib.foregroundcompat.ForegroundHelper;

public class ForegroundImageButton
...
implements ForegroundCompatView {
    ...
    public ForegroundImageButton(@NonNull Context context, @Nullable AttributeSet attrs, @AttrRes int defStyleAttr) {
