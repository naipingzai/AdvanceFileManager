...
class TrashAdapter(
    private val items: List<TrashFragment.TrashItem>,
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        ...
        binding.iconLayout.setOnClickListener {
            onIconClick(holder.bindingAdapterPosition)
        }
        return holder
    }
        ...
        holder.binding.apply {
            ...
            thumbnailImage.apply {
                ...
                if (supportsThumbnail) {
                    try {
                        val nioPath: Path = Paths.get(item.trashPath)
            ...
            val deleteTime = DateUtils.getRelativeTimeSpanString(
            ...
            descriptionText.text = listOf(deleteTime, size).joinToString(separator)
            pathText.text = item.originalPath
        }
    }
