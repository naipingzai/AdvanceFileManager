...
import naipingzai.materialfile.app.appClassLoader
import naipingzai.materialfile.app.application
import naipingzai.materialfile.util.Base64
import naipingzai.materialfile.util.asBase64
import naipingzai.materialfile.util.getBoolean
import naipingzai.materialfile.util.getFloat
import naipingzai.materialfile.util.getInteger
import naipingzai.materialfile.util.getStringArray
...
// Workaround for KT-60985: Enum<E> bound rejected, using Enum<*> instead.
