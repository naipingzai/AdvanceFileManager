...
import naipingzai.materialfile.lib.fastscroll.PopupTextProvider
import naipingzai.materialfile.R
import naipingzai.materialfile.coil.AppIconPackageName
import naipingzai.materialfile.compat.foregroundCompat
import naipingzai.materialfile.compat.getDrawableCompat
import naipingzai.materialfile.compat.isSingleLineCompat
import naipingzai.materialfile.databinding.FileItemGridBinding
import naipingzai.materialfile.databinding.FileItemListBinding
import naipingzai.materialfile.file.FileItem
import naipingzai.materialfile.file.fileSize
import naipingzai.materialfile.file.formatShort
...
import naipingzai.materialfile.provider.common.isEncrypted
...
import naipingzai.materialfile.ui.AnimatedListAdapter
import naipingzai.materialfile.ui.CheckableForegroundLinearLayout
import naipingzai.materialfile.ui.CheckableItemBackground
import naipingzai.materialfile.util.isMaterial3Theme
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        ...
        return holder.apply {
            ...
            popupMenu = PopupMenu(
                    ContextThemeWrapper(
                        menuButton.context,
                        R.style.ThemeOverlay_MaterialFiles_ActionBarPopup
                    ),
                    menuButton
                )
                .apply {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int, payloads: List<Any>) {
        ...
        holder.popupMenu.setOnMenuItemClickListener {
            when (it.itemId) {
                ...
                R.id.action_cut -> { listener.cutFile(file); true }
                R.id.action_copy -> { listener.copyFile(file); true }
                R.id.action_delete -> { listener.confirmDeleteFile(file); true }
                R.id.action_rename -> { listener.showRenameFileDialog(file); true }
