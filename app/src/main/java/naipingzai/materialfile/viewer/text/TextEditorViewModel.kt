...
import naipingzai.materialfile.provider.common.readAllBytes
import naipingzai.materialfile.provider.common.size
import naipingzai.materialfile.util.ActionState
import naipingzai.materialfile.util.DataState
import naipingzai.materialfile.util.isFinished
import naipingzai.materialfile.util.isReady
import naipingzai.materialfile.util.toError
import naipingzai.materialfile.util.toLoading
...
class TextEditorViewModel(file: Path) : ViewModel() {
    ...
    companion object {
        // 1MB limit for editor — files larger than this use LargeTextViewerFragment
