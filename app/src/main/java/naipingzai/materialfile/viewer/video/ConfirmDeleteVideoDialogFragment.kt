...
package naipingzai.materialfile.viewer.video
...
class ConfirmDeleteVideoDialogFragment : AppCompatDialogFragment() {
    ...
    companion object {
        fun show(path: Path, fragment: Fragment) {
            ConfirmDeleteVideoDialogFragment().putArgs(Args(path)).show(fragment)
        }
    }
