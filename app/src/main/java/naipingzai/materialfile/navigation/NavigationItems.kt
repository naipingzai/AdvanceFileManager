...
import naipingzai.materialfile.about.AboutFragment
...
import naipingzai.materialfile.file.JavaFile
import naipingzai.materialfile.file.asFileSize
import naipingzai.materialfile.settings.Settings
import naipingzai.materialfile.settings.SettingsActivity
...
import naipingzai.materialfile.settings.StandardDirectoryListFragment
import naipingzai.materialfile.storage.AddStorageDialogFragment
...
import naipingzai.materialfile.util.isMounted
...
private class IntentStorageItem(
    ...
    override fun onClick(listener: Listener) {
        val intent = storage.createIntent() ?: return
...
private class AddStorageItem : NavigationItem() {
    ...
    override fun onClick(listener: Listener) {
        listener.launchIntent(DialogHostActivity.createIntent<AddStorageDialogFragment>())
    }
}
...
private val menuItems: List<NavigationItem>
    ...
    get() = listOf(
        ...
        IntentMenuItem(
            ...
            ToolHostActivity.createIntent<AboutFragment>(R.string.about_title)
        )
    )
