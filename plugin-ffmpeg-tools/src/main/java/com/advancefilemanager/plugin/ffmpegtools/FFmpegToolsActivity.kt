...
import com.advancefilemanager.plugin.ffmpegtools.databinding.ActivityFfmpegToolsBinding
import java.io.File
...
class FFmpegToolsActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val filePaths = intent.getStringArrayExtra(PluginContract.EXTRA_FILE_PATHS)
        val actionType = intent.getStringExtra(PluginContract.EXTRA_ACTION_TYPE)
